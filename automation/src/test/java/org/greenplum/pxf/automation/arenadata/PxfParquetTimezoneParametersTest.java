...
public class PxfParquetTimezoneParametersTest extends BaseFeature {
    ...
    @Test(groups = {"arenadata"}, dataProvider = "parquetTypeParametersForExtTable")
    ...
    @Test(groups = {"arenadata"}, dataProvider = "parquetTypeParametersForConfig")
    ...
    @Test(groups = {"arenadata"}, dataProvider = "useLocalPxfTimezoneWriteProviderForExtTable")
    ...
    @Test(groups = {"arenadata"}, dataProvider = "useLocalPxfTimezoneWriteProviderForConfig")
    ...
    @Test(groups = {"arenadata"}, dataProvider = "useLocalPxfTimezoneReadProviderForExtTable")
    ...
    @Test(groups = {"arenadata"}, dataProvider = "useLocalPxfTimezoneReadProviderForConfig")
    ...
    @Test(groups = {"arenadata"}, dataProvider = "parquetTimestampWithSessionTimeZone")
    ...
    // According to the config from "automation/arenadata/conf/parquet/pxf-site.xml"
    @DataProvider
    ...
    private Object[][] useLocalPxfTimezoneWriteProviderForConfig() {
        return new Object[][]{
                {TIMESTAMP_TABLE_SCHEMA, TIMESTAMP, "arenadata/parquet/check-writable-tables/timestamp/false"},
                {TIMESTAMP_TABLE_SCHEMA_WITH_TIMEZONE, TIMESTAMP_WITH_TIMEZONE, "arenadata/parquet/check-writable-tables/timestamp-with-timezone"},
        };
    }
    ...
    private Object[][] useLocalPxfTimezoneReadProviderForConfig() {
        return new Object[][]{
                {TIMESTAMP_TABLE_SCHEMA, TIMESTAMP_PARQUET_FILE_NAME, "arenadata/parquet/check-readable-tables/timestamp/false"},
                {TIMESTAMP_TABLE_SCHEMA_WITH_TIMEZONE, TIMESTAMP_WITH_TIMEZONE_PARQUET_FILE_NAME, "arenadata/parquet/check-readable-tables/timestamp-with-timezone/false"}
        };
    }
    ...
    private Object[][] parquetTimestampWithSessionTimeZone() {
        return new Object[][]{
                {1, TIMESTAMP_TABLE_SCHEMA, TIMESTAMP, true, "arenadata/parquet/check-session-timezone/timestamp/int64"},
                {2, TIMESTAMP_TABLE_SCHEMA_WITH_TIMEZONE, TIMESTAMP_WITH_TIMEZONE, true, "arenadata/parquet/check-session-timezone/timestamp-with-timezone/int64"},
                {3, TIMESTAMP_TABLE_SCHEMA, TIMESTAMP, false, "arenadata/parquet/check-session-timezone/timestamp/int96"},
                {4, TIMESTAMP_TABLE_SCHEMA_WITH_TIMEZONE, TIMESTAMP_WITH_TIMEZONE, false, "arenadata/parquet/check-session-timezone/timestamp-with-timezone/int96"},
        };
    }
}
