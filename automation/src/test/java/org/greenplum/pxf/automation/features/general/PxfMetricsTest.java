...
public class PxfMetricsTest extends BaseFeature {
    ...
    @Test(groups = {"features", "gpdb"}, description = "Check cluster metrics")
    ...
    @Test(groups = {"features", "gpdb"}, description = "Check service metrics")
    ...
    @Test(groups = {"features", "gpdb"}, description = "Check service-metrics and service-metrics/cluster-metrics endpoints contain pxf thread metrics")
